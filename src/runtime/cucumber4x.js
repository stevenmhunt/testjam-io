...
module.exports = function runCucumber4x({ features, stepDefinitions, modules, logger }) {
    const cucumber = window.cucumber4;
    const dependencies = {
        cucumber,
        chai
    };
    if (!cucumber) {
        logger.error('Expected CucumberJS 4 script files to be loaded. Exiting...');
        return Promise.resolve();
    }
    logger.info(`Starting CucumberJS 4.2.1...\n`);
